...
external_stylesheets = [dbc.themes.DARKLY]  # Вместо FLATLY выберите свою тему из https://bootswatch.com/
...
sidebar = html.Div(
    [
        ...
        html.Hr(),
        html.P(
            "Учебный проект студента БСБО-14-21 Осминина Александра", className="lead"
        ),
        dbc.Nav(
            [
